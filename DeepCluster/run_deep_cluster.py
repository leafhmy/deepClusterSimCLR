...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', type=str, metavar='ARCH',
                        choices=['alexnet', 'vgg16', 'resnet'], default='vgg16',
    ...
    parser.add_argument('--exp', type=str, default='DeepCluster/checkpoints/', help='path to exp folder')
    parser.add_argument('--verbose', action='store_true', help='chatty')
    parser.add_argument('--faiss-gpu', action='store_true', default=False, help='use faiss-gpu')
    return parser.parse_args()


def run_deep_cluster(args):
    # fix random seeds
