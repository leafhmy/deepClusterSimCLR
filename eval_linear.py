...
class Loader:
    ...
    def getDataLoader(self, train_trans, val_trans):
        train_loader = DatasetLoader(self.anno, 'train', train_trans)
        val_loader = DatasetLoader(self.anno, 'val', val_trans)
...
parser.add_argument('--model', type=str, help='path to model',
                    default='/home/st003/hmy/DeepClusterSimCLR/checkpoints/checkpoint_dc.pth.tar')
...
def main():
    ...
    if args.tencrops:
        ...
        transformations_val = transforms.Compose([transforms.Resize(256),
    ...
    train_dataset, val_dataset = loader.getDataLoader(train_trans=transformations_train,
                                                      val_trans=transformations_val)
    ...
    # logistic regression
    reglog = RegLog(args.conv, len(train_dataset)).cuda()
    ...
    # create logs
    exp_log = os.path.join(args.exp, 'DeepCluster/log')
